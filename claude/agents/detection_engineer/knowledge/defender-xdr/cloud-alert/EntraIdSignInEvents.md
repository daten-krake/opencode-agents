...
Source: [https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-entraidsigninevents-table](https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-entraidsigninevents-table)

## Description

The `EntraIdSignInEvents` table in the advanced hunting schema contains information about Microsoft Entra interactive and non-interactive sign-ins. Use this reference to construct queries that return information from the table.
