---
description: Cloud CTI adviser that answers one scoped AdviserRequest with current threat evidence and no target-repository discovery.
mode: subagent
