---
description: Cloud purple-team adviser that answers one scoped AdviserRequest with expected telemetry, validation criteria, and coverage gaps.
mode: subagent
...
inspect the target repository or edit files.
