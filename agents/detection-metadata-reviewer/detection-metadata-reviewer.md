---
description: Tiny independent cloud reviewer for one deterministic empty id or owner repair, using compact runner evidence and no repository reads.
mode: subagent
...
load skills, invoke agents, use Bash, or run XDR.
